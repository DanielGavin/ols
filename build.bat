...
if "%1" == "test" (
    odin test tests -collection:src=src -debug-define:ODIN_TEST_TRACK_MEMORY=true -extra-linker-flags:"/STACK:4000000,2000000"
	...
	odin build tests -build-mode:test -collection:src=src -define:ODIN_TEST_TRACK_MEMORY=true -extra-linker-flags:"/STACK:4000000,2000000" %2
) else if "%1" == "debug" (
