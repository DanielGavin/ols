...
//modified from https://github.com/rust-analyzer/rust-analyzer/blob/master/editors/code/src/net.ts - 03.05.2021
...
export async function download(opts: DownloadOpts) {
    ...
    await vscode.window.withProgress(
        ...
        async (progress, _cancellationToken) => {
            ...
            await downloadFile(opts.url, opts.dest, opts.mode, opts.httpProxy, (readBytes, totalBytes) => {
